 ...
 * @version 2021/7/2317:08
 * @since JDK8
 */
public class ConnectionDecorator implements Connection {
    final Connection connection;

    final LinkedList<Connection> connectionPool;

    public ConnectionDecorator(final Connection connection, final LinkedList<Connection> connectionPool) {
        this.connection = connection;
        this.connectionPool = connectionPool;
    }

    /**
     * 将close 由关闭资源 变为 归还连接池
     *
     * @throws SQLException
     */
    @Override
